...
export function ProfilePage() {
  ...
  useEffect(() => {
    // Refresh the profile in the background: the one already loaded stays displayed
    if (isAuthenticated) {
      fetchUserProfile().catch((error) => console.error('Failed to load profile:', error));
    }
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    ...
                    >
                      <Sun
                        className={`w-6 h-6 ${theme === 'light' ? 'text-blue-500' : 'text-gray-500 dark:text-gray-400'}`}
                      />
                      <span
                    ...
                    >
                      <Moon
                        className={`w-6 h-6 ${theme === 'dark' ? 'text-blue-500' : 'text-gray-500 dark:text-gray-400'}`}
                      />
                      <span
                        className={`text-sm font-medium ${
                          theme === 'dark'
                    ...
                    >
                      <Monitor
                        className={`w-6 h-6 ${theme === 'system' ? 'text-blue-500' : 'text-gray-500 dark:text-gray-400'}`}
                      />
                      <span
                        className={`text-sm font-medium ${
                          theme === 'system'
