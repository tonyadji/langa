...
```json
{
  "id": "6950f2ae84f727530dc4bf60",
  "key": "APP-4RCvj9x9AXxOPkf38apwDO",
  "name": "Langa Backend",
  "logUsage": 20910850,
  "metricUsage": 0
}
...
**Frontend Mapping:** The frontend automatically maps this response to the `ApplicationUsage` TypeScript type with fields `totalLogBytes` and `totalMetricBytes`.
...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| guest | string | Yes | Email address of the user to invite |
...
```json
{
  ...
  "members": [
    {
      "email": "string",
      "role": "ADMIN",
      "addedDate": "2026-01-11T22:33:34.851Z"
    }
  ],
  "invitations": [
    {
      ...
      "invitationPeriod": {
        "inviteDate": "2026-01-11T22:33:34.851Z",
        "expiryDate": "2026-01-11T22:33:34.851Z"
      },
      "acceptedDate": "2026-01-11T22:33:34.851Z",
      "status": "ACCEPTED",
      "teamId": "string",
      "token": "string",
      "expired": true
  ...
  "createdBy": "string",
  "createdDate": "2026-01-11T22:33:34.851Z"
}
```
...
| totalLogBytes | long | Total log bytes (from backend `logUsage`) |
| totalMetricBytes | long | Total metric bytes (from backend `metricUsage`) |

**Constraints:**
- `key` unique index

**Mapping:** The frontend `useApplicationUsage` hook automatically maps the backend response to the frontend type.
