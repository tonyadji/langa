...
class ApplicationControllerTest {
    ...
    void createApplication_shouldReturnApplicationDto() {
        ...
        ApplicationInfo appInfo = new ApplicationInfo("appId", "MyApp", "appKey123", "accountKey123", "user@example.com", null);
    ...
    void getAllApplications_shouldReturnListOfApplicationDto() {
        ...
        ApplicationInfo app1 = new ApplicationInfo("1", "App1", "key1", "account1", "user@example.com", null);
        ApplicationInfo app2 = new ApplicationInfo("2", "App2", "key2", "account1", "user@example.com", null);
